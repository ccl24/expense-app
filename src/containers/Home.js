      ...
      <React.Fragment>
        <div className="App-header">
          ...
          <div className="content-area py-3 px-3">
            ...
            { tabView === CHART_VIEW &&
              <React.Fragment>
                <PieChart title="Total outcome this month" categoryData={chartOutcomDataByCategory} />
                <PieChart title="Total income this month" categoryData={chartIncomeDataByCategory} />
              </React.Fragment>
            }
            </React.Fragment>
          }
